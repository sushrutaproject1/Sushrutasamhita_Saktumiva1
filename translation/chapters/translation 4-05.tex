...
\gls{suṣavī}.\footnote{On \dev{jīvanīya} (\gls{jīvanīya}) see note
    ...
    version.  \dev{pariṣeka}, also \dev{parīṣeka}, is described as a form of bath by \Dalhana{4.29.10--12}{504} and \Dalhana{6.39.156}{684}.  See \volcite{1}[479]{josi-maha}.}
...
And because of the diagnosis of an elevated humour, one should 
employ blood-letting along with the therapies of vomiting, purging of bowels,
enema, and oily enema.\footnote{This is the “five therapy”
    (\dev{pañcakarma}) regime according to the \SS.}
