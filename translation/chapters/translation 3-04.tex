...
Learn from me about the rajasic ones.\footnote{As above, the text
    ...
    The sequence of rajasic body-types in the Nepalese version accords with
the commentary of Gayadāsa but differs from the vulgate; see
Table~\ref{rajasic-bodies}. The typology is paralleled in \CS\ 
\Ca{4.4.38}{323--324}, where the sequence of types is the same as
the Nepalese version, though expressed in prose.}
