...
and ritual worship.\footnote{The typology of sattvic body-types is
    paralleled in \CS\ \Ca{4.4.37}{323}, in a different sequence from 
    the Nepales and expressed in
    prose.  For a comparative study of these body types with passages
    in the astral literature, see \cite{zysk-2018}.}
    
    % Caraka: 1 brāhmyam, 2 ārṣam, 3 aindram, 4 yāmyam, 5 vāruṇam, 6 kauberaṃ, 7 gāndharvaṃ
...
Learn from me about the rajasic ones.\footnote{As above, the text
    ...
    case, as objects of \dev{nibodha} “learn from me.”  
    
    The sequence of rajasic body-types in the Nepalese version accords
with the commentary of Gayadāsa but differs from the vulgate; see
Table~\ref{rajasic-bodies}. The typology is
paralleled in \CS\ \Ca{4.4.38}{323--324}, where the sequence of
types is the same as the Nepalese version, though expressed in
prose.}
...
The qualities of the \se{paiśāca}{imp} include recklessness,
coarseness, and a tendency to impetuousness.  He is a lecher, he is
without shame.

\item[89cd--90ab] 

The man of a \se{sarpa}{serpent} nature is known to be sharp, full of
travail, angry, and timid by nature.  He is erratic regarding
where he roams and what he eats.

\newpage

\item[93cd--94ab]

The man of a \se{preta}{spectral} nature is known to be one who does
not share, is lazy, badly behaved and envious.  He is also lecherous,
and ungenerous.  

\item[90cd--91ab]

The man with the nature of an \se{śākuna}{omen bird} 
acts on sexually arousal, and he eats all the time.\footnote{We read
    \dev{āhāra} as a locative of the action noun; it could mean “taking all the time.”}  He is impatient and restless.\footnote{On śakuna omen birds, see
        \cite[6--8]{zysk-2025}.}
        
\item[94cd]
        
These are the six rajasic bodies.  Now learn the tamasic ones from me.
...
The qualities relating to timid domestic animals are known to be
folly, slowness, constant sleep and sex, and obstinacy.


\item[96]

The qualities essential to the nature of a fish are
instability, stupidity, timidity, fondness for water, and mutual
contact.

\item[97]

The person rooted in the nature of a tree lacks all aspects of
reasoning and enjoys food alone, being indifferent to  
favourite objects.

\item[98]

Thus these threefold bodies, the rajasic etc., have been described in full. 
Having recognized the constitution of the body, 
one should apply the appropriate therapy. 
